...
cf push "cities-${YOUR_NAME}-$BUILD_VERSION" -i 1 -m 512M -n "cities-${YOUR_NAME}-$ROUTE_VERSION" -d ${PCF_APP_DOMAIN} -p /artifacts/${YOUR_NAME}/build/libs/citytest-${BUILD_VERSION}.jar --no-manifest

echo "Is /artifacts/${YOUR_NAME}/build/libs/citytest-${BUILD_VERSION}.jar exists?"
pwd
ls -l /artifacts/${YOUR_NAME}/build/libs/citytest-${BUILD_VERSION}.jar
